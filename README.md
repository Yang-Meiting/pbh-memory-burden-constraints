...
- Montefalcone et al. (2026), *Phys. Rev. D* **113**, 023524, [arXiv:2503.21005](https://arxiv.org/abs/2503.21005) -- "Can a Breakdown of Hawking Evaporation Open a New Mass Window for Primordial Black Holes as Dark Matter?"
...
| File | Description |
|------|-------------|
| `pbh_evaporation.py` | Core PBH evaporation model (`PBHEvaporation` class, CMB/BBN constraints) |
| `pbh_memory_burden.ipynb` | Jupyter notebook with analysis, parameter scans, and figure generation |
...
1. Acharya & Khatri (2020), *JCAP* **06**, 018, [arXiv:2002.00898](https://arxiv.org/abs/2002.00898)
2. Kawasaki et al. (2018), *Phys. Rev. D* **97**, 023502
3. Keith et al. (2020), *Phys. Rev. D* **102**, 103512
4. Montefalcone et al. (2026), *Phys. Rev. D* **113**, 023524, [arXiv:2503.21005](https://arxiv.org/abs/2503.21005)
