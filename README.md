...
- **Montefalcone et al.** (2025), arXiv:2503.21005 [astro-ph.CO], *Phys. Rev. D* **113**, 023524 — *"Can a Breakdown of Hawking Evaporation Open a New Mass Window for Primordial Black Holes as Dark Matter?"*

This repository supports an ongoing study on phenomenological modeling of the continuous crossover from the semi-classical phase to the memory-burden phase in PBH evaporation.
...
| CMB + BBN combined constraints (reproducing Fig. 3 of Montefalcone+2025) | :white_check_mark: |
...
[pbh_memory_burden_CN.ipynb](pbh_memory_burden_CN.ipynb) — interactive notebook with code and inline comments (in Chinese).
...
Running the scripts produces the following figures (also available in the repository):
...
| `fig3_reproduction.png` | Combined CMB+BBN constraints (reproduces Fig. 3 of Montefalcone+2025) |
...
- Montefalcone et al. (2025), arXiv:2503.21005 [astro-ph.CO], *Phys. Rev. D* **113**, 023524
